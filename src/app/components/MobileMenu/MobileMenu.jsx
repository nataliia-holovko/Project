  ...
  render() {
    return (
      <div className="logo-content__mobile-menu">
        ...
        >
          <section className="mobile-menu" ref={this.menuRef}>
            <div className="mobile-menu__wrapper">
              <nav className="mobile-menu__link-content ">
                <div className="mobile-menu__close"></div>
                <Link to="/login">
                  <div className="mobile-menu__link-content_item mobile-menu__log-in">
                    <img
                ...
                <Link to="/">
                  <div className="mobile-menu__link-content_item">
                    <span>Home</span>
                  </div>
                </Link>
                <Link to="/meet">
